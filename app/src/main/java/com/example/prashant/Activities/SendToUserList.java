package com.example.prashant.Activities;
...
import com.example.prashant.Adapters.SendToUserAdapter;
import com.example.prashant.DatabaseHelper.Myhelper;
import com.example.prashant.R;
import com.example.prashant.DatabaseHelper.TransactionHelper;
import com.example.prashant.Data.User;
import com.example.prashant.DatabaseHelper.UserContract.UserEntry;
import com.example.prashant.DatabaseHelper.TransactionContract.TransactionEntry;
...
public class SendToUserList extends AppCompatActivity implements SendToUserAdapter.OnUserListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Show list of items
        recyclerView = findViewById(R.id.send_to_users_list);
    ...
    public void onUserClick(int position) {
        ...
        startActivity(new Intent(SendToUserList.this, WelcomeActivity.class));
        finish();
    }
    ...
    private void calculateAmount() {
        ...
        new Myhelper(this).updateAmount(fromUserAccountNo, remainingAmount);
        new Myhelper(this).updateAmount(toUserAccountNo, increasedAmount);
    }
